...
#define HPCR2	0x04
/*
 * i.MX27 note: manual says this port is a host port. But its connected
 * like the other peripheral ports to the external SSI_4* pin group
*/
#define HPCR3	0x08

/* all host ports share these bits */
#define HPCR_SYN	(1 << 12)
#define HPCR_RXDSEL(x)	(((x) & 0x7) << 13)
#define HPCR_TFCSEL(x)	(((x) & 0xf) << 26)
#define HPCR_TCLKDIR	(1 << 30)
#define HPCR_TFSDIR	(1 << 31)

#define HPCR_RFCSEL(x)	(((x) & 0xf) << 20)
#define HPCR_RCLKDIR	(1 << 24)
#define HPCR_RFSDIR	(1 << 25)
...
#define PPCR_SYN	(1 << 12)
#define PPCR_RXDSEL(x)	(((x) & 0x7) << 13)
#define PPCR_TFCSEL(x)	(((x) & 0xf) << 26)
#define PPCR_TCLKDIR	(1 << 30)
#define PPCR_TFSDIR	(1 << 31)

#define PPCR_RFCSEL(x)	(((x) & 0xf) << 20)
#define PPCR_RCLKDIR	(1 << 24)
#define PPCR_RFSDIR	(1 << 25)
 ...
 */
int mx2_audmux_configure_sync_slave(unsigned int ssi_unit,
