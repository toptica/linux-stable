...
#define VA(a)			_AT(void __iomem *, a)

/* The following addresses are common between i.MX21 and i.MX27 */

/* Register offests */
#define AIPI_BASE_ADDR		UL(0x10000000)
#define AIPI_BASE_ADDR_VIRT	VA(0xF4000000)
...
#define AVIC_BASE_ADDR		UL(0x10040000)

#define SAHB1_BASE_ADDR		UL(0x80000000)
#define SAHB1_BASE_ADDR_VIRT	VA(0xF4100000)
