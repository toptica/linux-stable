 ...
 * @param   channel           channel number
 */
extern void mxc_free_sdma(int channel);
 ...
 */
extern void sdma_free(void *buf);
...
/*
 * i.MX DMA API compatibility
 */
#include <mach/dma-mx1-mx2.h>

extern int mxc_sdma_alloc_channel(int channel, const char *name);
extern mxc_dma_channel_t *mxc_sdma_get_channel(int channel);
extern mxc_sdma_channel_params_t *mxc_sdma_get_params(int channel);
