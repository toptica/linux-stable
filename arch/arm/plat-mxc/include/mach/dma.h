 ...
 */
extern int mxc_dma_request_ext(mxc_dma_device_t channel_id, const char *dev_name,
			       struct dma_channel_info *info);

static inline int mxc_dma_request(mxc_dma_device_t channel_id, const char *dev_name)
{
