...
/* IRAM */
#define IRAM_BASE_ADDR		UL(0xFFFF4C00)	/* internal ram */
...
/* ROM patch */
#define ROMP_BASE_ADDR		UL(0x10041000)
...
#define X_MEMC_BASE_ADDR	UL(0xD8000000)
#define X_MEMC_BASE_ADDR_VIRT	VA(0xF4200000)
