...
static struct omap_mux __initdata omap3_muxmodes[] = {
	_OMAP3_MUXENTRY(CCDC_D0, 99,
		"ccdc_d0", NULL, NULL, NULL,
		"gpio_99", NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D1, 100,
		"ccdc_d1", NULL, NULL, NULL,
		"gpio_100", NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D2, 101,
		"ccdc_d2", NULL, NULL, NULL,
		"gpio_101", "hw_dbg4", NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D3, 102,
		"ccdc_d3", NULL, NULL, NULL,
		"gpio_102", "hw_dbg5", NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D4, 103,
		"ccdc_d4", NULL, NULL, NULL,
		"gpio_103", "hw_dbg6", NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D5, 104,
		"ccdc_d5", NULL, NULL, NULL,
		"gpio_104", "hw_dbg7", NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D6, 105,
		"ccdc_d6", NULL, NULL, NULL,
		"gpio_105", NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_D7, 106,
		"ccdc_d7", NULL, NULL, NULL,
		"gpio_106", NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_FLD, 95,
		"ccdc_fld", "ccdc_data_8", "uart4_tx", "i2c4_scl",
		"gpio_95", "hw_dbg1", NULL, "safe_mode"),
	_OMAP3_MUXENTRY(CCDC_HD, 96,
		"ccdc_hd", NULL, "uart4_rts", NULL,
		"gpio_96", "hw_dbg0", NULL, "safe_mode"),
	...
	_OMAP3_MUXENTRY(CCDC_WEN, 98,
		"ccdc_wen", "ccdc_data_9", "uart4_rx", NULL,
...
struct omap_ball __initdata omap3_cbc_ball[] = {
	_OMAP3_BALLENTRY(CCDC_D0, "ae16", NULL),
	_OMAP3_BALLENTRY(CCDC_D1, "ae15", NULL),
	_OMAP3_BALLENTRY(CCDC_D10, "d25", NULL),
	_OMAP3_BALLENTRY(CCDC_D11, "e26", NULL),
	_OMAP3_BALLENTRY(CCDC_D2, "a24", NULL),
	_OMAP3_BALLENTRY(CCDC_D3, "b24", NULL),
	_OMAP3_BALLENTRY(CCDC_D4, "d24", NULL),
	_OMAP3_BALLENTRY(CCDC_D5, "c24", NULL),
	_OMAP3_BALLENTRY(CCDC_D6, "p25", NULL),
	_OMAP3_BALLENTRY(CCDC_D7, "p26", NULL),
	_OMAP3_BALLENTRY(CCDC_D8, "n25", NULL),
	_OMAP3_BALLENTRY(CCDC_D9, "n26", NULL),
	_OMAP3_BALLENTRY(CCDC_FLD, "b23", NULL),
	_OMAP3_BALLENTRY(CCDC_HS, "c23", NULL),
	_OMAP3_BALLENTRY(CCDC_PCLK, "c26", NULL),
	_OMAP3_BALLENTRY(CCDC_STROBE, "d26", NULL),
	_OMAP3_BALLENTRY(CCDC_VS, "d23", NULL),
	_OMAP3_BALLENTRY(CCDC_WEN, "a23", NULL),
	_OMAP3_BALLENTRY(CCDC_XCLKA, "c25", NULL),
	_OMAP3_BALLENTRY(CCDC_XCLKB, "e25", NULL),
...
struct omap_ball __initdata omap3_cbb_ball[] = {
	_OMAP3_BALLENTRY(CCDC_D0, "ag17", NULL),
	_OMAP3_BALLENTRY(CCDC_D1, "ah17", NULL),
	_OMAP3_BALLENTRY(CCDC_D2, "b24", NULL),
	_OMAP3_BALLENTRY(CCDC_D3, "c24", NULL),
	_OMAP3_BALLENTRY(CCDC_D4, "d24", NULL),
	_OMAP3_BALLENTRY(CCDC_D5, "a25", NULL),
	_OMAP3_BALLENTRY(CCDC_D6, "k28", NULL),
	_OMAP3_BALLENTRY(CCDC_D7, "l28", NULL),
	_OMAP3_BALLENTRY(CCDC_FLD, "c23", NULL),
	_OMAP3_BALLENTRY(CCDC_HD, "a24", NULL),
	_OMAP3_BALLENTRY(CCDC_VD, "a23", NULL),
	_OMAP3_BALLENTRY(CCDC_WEN, "b23", NULL),
