...
#define DEFINE_CLOCKx(name, i, er, es, gr, sr)		\
...
DEFINE_CLOCKx(cspi1_clk,  0, MX25_CCM_BASE + CCM_CGCR1,  5, get_rate_ipg, NULL);
DEFINE_CLOCKx(cspi2_clk,  0, MX25_CCM_BASE + CCM_CGCR1,  6, get_rate_ipg, NULL);
DEFINE_CLOCKx(cspi3_clk,  0, MX25_CCM_BASE + CCM_CGCR1,  7, get_rate_ipg, NULL);
