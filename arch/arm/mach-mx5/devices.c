...
static struct resource mx51_ipu_resources[] = {
	{
		...
		.end = IPU_CTRL_BASE_ADDR + SZ_512M - 1,
		.flags = IORESOURCE_MEM,
	},
	{
...
static struct resource mx51_spi1_resources[] = {
	{
		...
		.end = CSPI1_BASE_ADDR + 0x43,
		.flags = IORESOURCE_MEM,
	},
	{
		.start = MXC_INT_ECSPI1,
		.end = MXC_INT_ECSPI1,
		.flags = IORESOURCE_IRQ,
	},
};
...
static struct resource mx51_spi2_resources[] = {
	{
		...
		.end = CSPI2_BASE_ADDR + 0x43,
		.flags = IORESOURCE_MEM,
	},
	{
		.start = MXC_INT_ECSPI2,
		.end = MXC_INT_ECSPI2,
		.flags = IORESOURCE_IRQ,
	},
};
...
static struct resource mx51_keypad_resources[] = {
	{
		.start	= 0x73f94000,
		.end	= 0x73f94000 + 0x7,
		.flags	= IORESOURCE_MEM,
...
struct platform_device mx51_keypad_device = {
	.name = "imx-keypad",
	.id = -1,
	.num_resources = ARRAY_SIZE(mx51_keypad_resources),
	.resource = mx51_keypad_resources,
};
#endif
