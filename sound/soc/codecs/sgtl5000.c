...
static const struct snd_kcontrol_new sgtl5000_snd_controls[] = {
	...
	SOC_DOUBLE("Headphone Volume",
		SGTL5000_CHIP_ANA_HP_CTRL, 0, 8, 0x7f, 1),
};
				  ...
				  struct snd_soc_dai *dai)
{
	...
	pr_debug("%s: sample rate %d\n", __func__,
		sgtl5000->lrclk);
#if 0
	/* SGTL5000 rev1 has an IC bug that prevents switching to MCLK from PLL. */
...
static int sgtl5000_probe(struct platform_device *pdev)
{
	...
	lo_ctrl |= (SGTL5000_LINE_OUT_CURRENT_360u <<
